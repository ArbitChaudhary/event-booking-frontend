...
export default function SportsDetail() {
	const {id} = useParams()
	const[oneSport, setOneSport] = useState(null)
	useEffect(()=>{
					...
					<div className="col-lg-8">
						<section id="description">
							...
							<div className="pictures_grid magnific-gallery clearfix">
							    <figure><a href="assets/images/detail_gallery/detail_1.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src={oneSport.user_images[0]} alt="" /></a></figure>
							    <figure><a href="assets/images/detail_gallery/detail_2.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src={oneSport.user_images[1]} alt=""/></a></figure>
							    <figure><a href="assets/images/detail_gallery/detail_3.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src={oneSport.user_images[2]} alt=""/></a></figure>
							    <figure><a href="assets/images/detail_gallery/detail_4.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src={oneSport.user_images[3]} alt=""/></a></figure>
							    <figure><a href="assets/images/detail_gallery/detail_5.jpg" title="Photo title" data-effect="mfp-zoom-in"><span className="d-flex align-items-center justify-content-center">+10</span><img src={oneSport.user_images[4]} alt="" /></a></figure>
							</div>
							{/* <!-- /pictures --> */}
							...
							<div className="room_type gray">
								<div className="row">
									<div className="col-md-4">
										<img src="assets/images/gallery/hotel_list_2.jpg" className="img-fluid" alt="" />
									</div>
									<div className="col-md-8">
									<h4>Antman</h4>
									<div className='score' > <strong>$100</strong></div>
										...
										<ul className="hotel_facilities">
											...
											<li><img src="assets/images/hotel_facilites_icon_4.svg" alt="" />Free Wifi</li>
											<li><img src="assets/images/hotel_facilites_icon_6.svg" alt="" />Bathtub</li>
											<li> <div className="counter"><CgMathMinus onClick={negCount} className='plus'/><b>{ticketCount}</b> <CgMathPlus onClick={poCount} className='plus' /></div> </li>
											<li><a href="#sidebar"><div className="book">  BOOK</div> </a></li>
							...
							<div className="room_type last">
								<div className="row">
									<div className="col-md-4">
										<img src="/assets/images/gallery/hotel_list_3.jpg" className="img-fluid" alt="" />
									</div>
									<div className="col-md-8">
									<h4>Antman</h4>
									<div className='score' > <strong>$100</strong></div>
										...
										<p>Sit an meis aliquam, cetero inermis vel ut. An sit illum euismod facilisis, tamquam vulputate pertinacia eum at.</p>
										<ul className="hotel_facilities">
											<li><img src="assets/images/hotel_facilites_icon_3.svg" alt="" />King size Bed</li>
											<li><img src="assets/images/hotel_facilites_icon_4.svg" alt="" />Free Wifi</li>
											<li><img src="assets/images/hotel_facilites_icon_6.svg" alt="" />Bathtub</li>
											<li> <div className="counter"><CgMathMinus onClick={negCount} className='plus'/><b>{ticketCount}</b> <CgMathPlus onClick={poCount} className='plus' /></div> </li>
											<li><a href="#sidebar"><div className="book">  BOOK</div> </a></li>
					...
					<aside className="col-lg-4" id="sidebar">
						<div className="box_detail booking">
							...
							<div className="panel-dropdown">
								<a href="#">Guests <span className="qtyTotal">{ticketCount} </span></a>
							...
							</div>							<a href="wishlist.html" className="btn_1 full-width outline wishlist"><i className="icon_heart"></i> Add to wishlist</a>
						...
						<a href="wishlist.html" className="btn_1 full-width outline wishlist"><i className="icon_heart"></i> Antman ({ticketCount})</a>
							...
							<form action="" className='stripe-form'>
								...
								<a href="cart-1.html" className=" add_top_30 btn_1 full-width purchase">Confirm</a>
